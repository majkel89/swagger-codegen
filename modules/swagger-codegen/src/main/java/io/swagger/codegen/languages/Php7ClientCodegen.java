...
/**
 * - Framework agnostic PHP7 client generator
 * - Use PSR interfaces for HTTP
 *     PSR-18: HTTP Client
 ...
 *       https://github.com/php-fig/http-message-util // http method and statuses standardized
 *     PSR-17: HTTP Factories
 *       https://www.php-fig.org/psr/psr-17/
 *       https://github.com/php-fig/http-factory
 * - Perform request and response validation (inside model classes)
 * - ??? Request objects
 * - Clean PHP 7 compliant code
 */
public class Php7ClientCodegen extends DefaultCodegen implements CodegenConfig {
    @SuppressWarnings("hiding")
    static Logger LOGGER = LoggerFactory.getLogger(Php7ClientCodegen.class);
    ...
    public Php7ClientCodegen() {
        ...
        embeddedTemplateDir = templateDir = "php7";
